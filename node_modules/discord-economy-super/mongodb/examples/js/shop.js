...
bot.on('messageCreate', async message => {
    ...
    if (message.content == '+shop') {
        ...
        message.channel.send(shop.map(item => `ID: **${item.id}** - **${item.name}** (**${item.price}** coins), description: **${item.description}**, max amount in inventory: **${item.maxAmount || Infinity}**. Role: ${item.role || '**This item don\'t give you a role.**'}`).join('\n'))
    }
